...
public class CSVDataReader {
	...
	public ArrayList<String> getMetadata() throws FileNotFoundException{
		try {
			String[] header = this.reader.readNext();
			ArrayList<String> list = new ArrayList<String>();
			for (int i=0; i < header.length; i++) {
				list.add(i, new String (header[i]));
			}
			return list;
	...
	public boolean loadData(int drugCodeColumn, 
							int compoundNameColumn,
							int brandNameColumn,
							int strengthColumn,
							int manufacturerIdColumn,
							int manufacturerNameColumn,
							int categoryNameColumn) throws FileNotFoundException {
	    try {

	        String[] line;
	        
	        while ((line = reader.readNext()) != null) {
	        	String drugCode = line [drugCodeColumn];
	        	String compoundName = line[compoundNameColumn];
	        	String brandName = line[brandNameColumn];
	        	String strength = line[strengthColumn];
	        	String manufacturerId = line[manufacturerIdColumn]; // It should be automatically generated by the application to avoid conflict of different resources with same id, or should use the country abbreviation concatenated 
	        	String manufacturerName = line[manufacturerNameColumn];
	        	String categoryName = line[categoryNameColumn];
